    ...
    <div className="flex flex-col mb-[77px] sm:w-[399px] w-11/12  bg-white rounded-[19px] gap-4">
      <div className="flex flex-col gap-2.5 p-2.5">
        ...
        <form
          ...
          className={`flex ${pocketForm.error ? 'border-[1px] border-red-600' : 'border-0'} flex-row w-full h-[40px] py-[3px] pr-[3px] pl-3 bg-gray-50 gap-3 rounded-[10px] items-center`}
        >
          <img
